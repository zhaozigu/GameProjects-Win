/// \file Math.hpp
/// \brief Math utility functions header file
...
namespace Math
{
    ...
    /// \param epsilon Optional epsilon value to use for the check (default is 0.001f)
    ...
    /// \brief Clamp a value between a lower and upper limit
    /// \tparam T Type of the values
    ...
    /// \brief Calculate the arc cosine of a value
    /// \param value Input value
    /// \return Arc cosine of the input value
    inline float Acos(float value)
    {
        return acosf(value);
    }

    /// \brief Calculate the arctangent of two values (y, x)
    /// \param y Y value
    /// \param x X value
    /// \return Arctangent of the two values
    inline float Atan2(float y, float x)
    {
        return atan2f(y, x);
    }

    /// \brief Calculate the cotangent of an angle
    /// \param angle Angle in radians
    ...
    /// \param a First value
    /// \param b Second value
    /// \param f Interpolation factor (0.0f to 1.0f)
    ...
    /// \brief Calculate the floating-point remainder of two values
    /// \param numer Numerator
    /// \param denom Denominator
    /// \return Floating-point remainder of the two values
